 ...
 * </p>
 * <ul>
 *   <li>{@link ItinerarioDSL.impl.VueloImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link ItinerarioDSL.impl.VueloImpl#getOrigen <em>Origen</em>}</li>
 *   <li>{@link ItinerarioDSL.impl.VueloImpl#getDestino <em>Destino</em>}</li>
 *   <li>{@link ItinerarioDSL.impl.VueloImpl#getSalida <em>Salida</em>}</li>
 *   <li>{@link ItinerarioDSL.impl.VueloImpl#getLlegada <em>Llegada</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VueloImpl extends MinimalEObjectImpl.Container implements Vuelo {
	...
	protected EClass eStaticClass() {
		return ItinerarioDSLPackage.Literals.VUELO;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerarioDSLPackage.VUELO__NOMBRE, oldNombre, nombre));
	}
	...
	public void setOrigen(String newOrigen) {
		...
		origen = newOrigen;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerarioDSLPackage.VUELO__ORIGEN, oldOrigen, origen));
	}
	...
	public void setDestino(String newDestino) {
		...
		destino = newDestino;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerarioDSLPackage.VUELO__DESTINO, oldDestino, destino));
	}
	...
	public void setSalida(Date newSalida) {
		...
		salida = newSalida;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerarioDSLPackage.VUELO__SALIDA, oldSalida, salida));
	}
	...
	public void setLlegada(Date newLlegada) {
		...
		llegada = newLlegada;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItinerarioDSLPackage.VUELO__LLEGADA, oldLlegada, llegada));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ItinerarioDSLPackage.VUELO__NOMBRE:
				return getNombre();
			case ItinerarioDSLPackage.VUELO__ORIGEN:
				return getOrigen();
			case ItinerarioDSLPackage.VUELO__DESTINO:
				return getDestino();
			case ItinerarioDSLPackage.VUELO__SALIDA:
				return getSalida();
			case ItinerarioDSLPackage.VUELO__LLEGADA:
				return getLlegada();
		}
